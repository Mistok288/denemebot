...
module.exports = {
  ...
  run: async (client, message, args, embed) => {
    ...
    client.api.channels(message.channel.id).messages.post({
      data: {
        "content": `${green} Aşağıda ki düğmeden hesabınızın 7 gün süresini dolurmasına kalan süresini görüntüleyebilirsiniz ve tıklayarak şüpheliden çıkabilirsiniz.`, "components": [{
          "type": 1, "components": [

            { "type": 2, "style": 2, "custom_id": "süpheli", "label": "Hesap Kontrol", "emoji": { "id": "916734243328114718" } },
