  ...
  .setStyle("DANGER"),
      ...
      collector.on("collect", async interaction => {
        ...
        if (interaction.customId === "kanal") {
          ...
          const parent = await interaction.guild.channels.create('WENDOS LOGLAR', {
            type: 'GUILD_CATEGORY',
        ...
        if (interaction.customId === "emoji") {
          ...
          const emojis = [
              ...
              { name: "wendosspotify", url: "https://cdn.discordapp.com/emojis/899337292840312912.png?size=44" },
              { name: "wendosnetflix", url: "https://cdn.discordapp.com/emojis/941993358518284298.webp?size=96&quality=lossless" },
              { name: "wendosexxen", url: "https://cdn.discordapp.com/emojis/900396713116835900.png?size=44" },
              { name: "wendosblutv", url: "https://cdn.discordapp.com/emojis/900396707362246666.png?size=44" },
              { name: "wendosnitro", url: "https://cdn.discordapp.com/emojis/941993742934614047.webp?size=96&quality=lossless" },
              { name: "wendosyoutube", url: "https://cdn.discordapp.com/emojis/941993963013935115.gif?size=96&quality=lossless" },
