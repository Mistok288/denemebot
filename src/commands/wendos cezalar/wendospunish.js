...
new MessageButton().setCustomId("bir").setLabel("1").setStyle(1),
new MessageButton().setCustomId("iki").setLabel("2").setStyle(2),
new MessageButton().setCustomId("üç").setLabel("3").setStyle(3),
new MessageButton().setCustomId("iptal").setLabel("X").setStyle(4)
);
