...
module.exports = {
  ...
  run: async (client, message, args, embed) => {
    ...
    client.api.channels(message.channel.id).messages.post({
      data: {
        "content": `Alttaki butonları kullanarak sunucumuzdaki ceza bilgilerini ögrenebilirsin \n \`Ceza Puanını , Cezalarını, Kalan Zamanını?\``, "components": [{
          "type": 1, "components": [

            { "type": 2, "style": 4, "custom_id": "cezapuan", "label": "Ceza Puanı", "emoji": { "id": "1059929495886364835" } },
            { "type": 2, "style": 1, "custom_id": "cezalarım", "label": "Cezalarım", "emoji": { "id": "1059169885982294106" } },
            { "type": 2, "style": 3, "custom_id": "kalanzaman", "label": "Kalan Zamanım?", "emoji": { "id": "1065609540445405306" } }
          ]
        }]
      }
    })
